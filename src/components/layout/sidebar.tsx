        ...
        <div className={cn(
            ...
            {!className && (
                <button
                    ...
                    className="cursor-pointer absolute -right-3 top-10 h-6 w-6 bg-white border border-slate-200 rounded-full flex items-center justify-center shadow-sm hover:bg-slate-50 transition-colors z-10"
                >
